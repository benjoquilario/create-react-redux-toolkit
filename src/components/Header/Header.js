         ...
         <div className="w-full max-w-6xl mx-auto flex justify-between items-center md:justify-start">
            ...
            <nav className="md:ml-8 md:flex-1 order-[-1] md:order-none">
               ...
               <div
                  ...
                  } bg-[#0a1f49] absolute top-[50px] left-0 px-5 flex items-center justify-start w-full z-9999 overflow-hidden transition-all md:relative md:top-[unset] md:overflow-visible`}
               >
